...
/**
 * A combo box to control the visible time range for one or more Plotter components. When used with two or more
 * Plotters, it also acts to coordinate the range between them.
 */
