...
import com.druvu.jconsole.util.Formatter;
...
public class SummaryTab extends Tab {
                ...
                for (GarbageCollectorMXBean garbageCollectorMBean : garbageCollectors) {
                    ...
                    append(
                            ...
                            Resources.format(
                                    ...
                                    gcName,
                                    gcCount,
                                    (gcTime >= 0) ? Formatter.formatTime(gcTime) : Messages.UNAVAILABLE),
                            4);
                }
                append(endTable);
            }
    ...
    /** Tries to get the specified value from the list of suppliers. Returns -1 if all suppliers fail. */
