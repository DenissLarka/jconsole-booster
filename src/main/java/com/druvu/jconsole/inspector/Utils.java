...
public class Utils {
	...
	private static final Set<Class<?>> primitiveWrappers = new HashSet<Class<?>>(
			Arrays.asList(new Class<?>[]{Byte.class, Short.class, Integer.class, Long.class, Float.class, Double.class,
	...
	private static final Set<String> extraNumericalTypes = new HashSet<String>(Arrays
			.asList(new String[]{BigDecimal.class.getName(), BigInteger.class.getName(), Number.class.getName()}));
	...
	public static Throwable getActualException(Throwable e) {
		...
		if (e instanceof MBeanException || e instanceof RuntimeMBeanException || e instanceof RuntimeOperationsException
