    ...
    private String formatDetails() {
        ...
        try {
            ...
            for (GarbageCollectorMXBean garbageCollectorMBean : garbageCollectors) {
                ...
                String str = Resources.format(
                        Messages.GC_TIME_DETAILS,
                        Formatter.justify(Formatter.formatTime(gcTime), 14),
                        gcName,
        ...
        protected class AccessiblePoolChart extends AccessibleJPanel {
            public String getAccessibleName() {
                ...
                for (PoolPlotter poolPlotter : poolPlotters) {
                    ...
                    keyValueList += Resources.format(
                            Messages.PLOTTER_ACCESSIBLE_NAME_KEY_AND_VALUE, poolPlotter.toString(), value);
        ...
        private void updateMemoryInfo(long used, long committed, long max) {
            getInfoLabel()
                    .setText(Resources.format(
                            ...
                            Formatter.formatBytes(used, true),
                            Formatter.formatBytes(committed, true),
                            Formatter.formatBytes(max, true)));
        }
    }
}
