...
public class Utilities {
	...
	/**
	 * A slightly modified border for JScrollPane to be used with a JTable inside a
	 * JTabbedPane. It has only top part and the rest is clipped to make the overall
	 * border less thick. The top border helps differentiating the containing table
	 * from its container.
	 */
