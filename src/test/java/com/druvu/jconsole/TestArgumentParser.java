...
public class TestArgumentParser {
    ...
    public void emptyArgsYieldDefaultOptions() {
        ...
        Assert.assertTrue(o.vmids().isEmpty());
    }
    ...
    @Test
    public void rmiShorthandAsTargetExpands() {
        JConsoleOptions o =
                ArgumentParser.parse(new String[] {"rmi:localhost:1234"}).orElseThrow();
        Assert.assertEquals(o.urls().size(), 1);
        Assert.assertEquals(o.urls().get(0), "service:jmx:rmi:///jndi/rmi://localhost:1234/jmxrmi");
    }
