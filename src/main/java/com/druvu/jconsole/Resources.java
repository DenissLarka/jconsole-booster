...
public final class Resources {
    ...
    /**
     * Returns a {@link String} where all <code>\n</code> in the <text> have been
     * replaced with the line separator for the platform.
     *
     * @param text
     *            the to be replaced
     *
    ...
    /**
     * Removes the mnemonic identifier (<code>&</code>) from a string unless it's
     * escaped by <code>&&</code> or placed at the end.
     *
     * @param message
     *            the message
     *
     ...
     *
     * @return the mnemonic as an <code>int</code>, or <code>0</code> if it can't be
     *         found.
     */
