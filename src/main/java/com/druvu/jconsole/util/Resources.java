...
public final class Resources {
    private static Map<String, Integer> MNEMONIC_LOOKUP =
            Collections.synchronizedMap(new IdentityHashMap<String, Integer>());
    ...
    /**
     * Initializes all public static non-final fields in the given class with messages from a {@link ResourceBundle}.
     *
    ...
    /**
     * Returns a {@link String} where all <code>\n</code> in the <text> have been replaced with the line separator for
     * the platform.
     *
    ...
    /**
     * Removes the mnemonic identifier (<code>&</code>) from a string unless it's escaped by <code>&&</code> or placed
     * at the end.
     *
     * @param message the message
     ...
     *
     * <p>The mnemonic character is the first character followed by the first <code>&</code> that is not followed by
     * another <code>&</code>.
     *
     * @return the mnemonic as an <code>int</code>, or <code>0</code> if it can't be found.
     */
