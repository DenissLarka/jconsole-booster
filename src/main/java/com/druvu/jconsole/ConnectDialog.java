...
public class ConnectDialog extends InternalDialog
    ...
    public void revalidate() {
        ...
        disabledTableCellColor = Utilities.ensureContrast(new Color(0x808080), UIManager.getColor("Table.background"));
    ...
    public void setConnectionParameters(
            String url, String host, int port, String userName, String password, String msg) {
