...
public class XTree extends JTree {
    ...
    static {
        String keyPropertyList =
                System.getProperty("com.tools.jconsole.mbeans.keyPropertyList");
    ...
    private DefaultMutableTreeNode removeParentFromView(
        ...
        if ((!node.isRoot()) && node.isLeaf() &&
                (!(((XNodeInfo) node.getUserObject()).getType().equals(XNodeInfo.Type.MBEAN)))) {
            DefaultMutableTreeNode parent =
                    (DefaultMutableTreeNode) node.getParent();
    ...
    private synchronized void addMBeanToView(
        ...
        if (nodes.containsKey(hashKey)) {
            ...
            XNodeInfo userObject =
                    new XNodeInfo(XNodeInfo.Type.MBEAN, data, label, mbean.toString());
    ...
    private synchronized void changeNodeValue(
        ...
        if (nodeValue.getType().equals(XNodeInfo.Type.MBEAN)) {
            removeMetadataNodes(node);
    ...
    private DefaultMutableTreeNode createDomainNode(Dn dn, Token token) {
        ...
        XNodeInfo userObject =
                new XNodeInfo(XNodeInfo.Type.NONMBEAN, label, label, label);
    ...
    private DefaultMutableTreeNode createDnNode(
        ...
        Object data = createNodeValue(xmbean, token);
        String label = data.toString();
        XNodeInfo userObject = new XNodeInfo(XNodeInfo.Type.MBEAN, data, label,
    ...
    private DefaultMutableTreeNode createSubDnNode(Dn dn, Token token) {
        ...
        XNodeInfo userObject =
                new XNodeInfo(XNodeInfo.Type.NONMBEAN, label, label, token.getTokenValue());
        node.setUserObject(userObject);
        return node;
    }
     ...
     * MBean tree. If the "com.tools.jconsole.mbeans.keyPropertyList" system
    ...
    private static class MBeanInfoNodesSwingWorker
        ...
        private void addMBeanInfoNodes(
            ...
            if (ai != null && ai.length > 0) {
                ...
                XNodeInfo attributesUO = new XNodeInfo(XNodeInfo.Type.ATTRIBUTES, mbean,
                ...
                for (MBeanAttributeInfo mbai : ai) {
                    ...
                    XNodeInfo attributeUO = new XNodeInfo(XNodeInfo.Type.ATTRIBUTE,
            ...
            if (oi != null && oi.length > 0) {
                ...
                XNodeInfo operationsUO = new XNodeInfo(XNodeInfo.Type.OPERATIONS, mbean,
                ...
                for (MBeanOperationInfo mboi : oi) {
                    ...
                    XNodeInfo operationUO = new XNodeInfo(XNodeInfo.Type.OPERATION,
            ...
            if (isBroadcaster != null && isBroadcaster.booleanValue()) {
                ...
                XNodeInfo notificationsUO = new XNodeInfo(XNodeInfo.Type.NOTIFICATIONS, mbean,
                ...
                if (ni != null && ni.length > 0) {
                    for (MBeanNotificationInfo mbni : ni) {
                        ...
                        XNodeInfo notificationUO = new XNodeInfo(XNodeInfo.Type.NOTIFICATION,
