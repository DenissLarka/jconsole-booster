...
public final class SheetDialog {
    ...
    public static JOptionPane showOptionDialog(
        ...
        final SheetOptionPane optionPane =
                new SheetOptionPane(message, messageType, optionType, icon, options, initialValue);
