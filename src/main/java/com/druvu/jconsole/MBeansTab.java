...
import com.druvu.jconsole.inspector.XDataViewer;
	...
	private void buildMBeanServerView() {
		new SwingWorker<Set<ObjectName>, Void>() {
			...
			public Set<ObjectName> doInBackground() {
				...
				//
				try {
					getMBeanServerConnection().addNotificationListener(MBeanServerDelegate.DELEGATE_NAME,
							MBeansTab.this, null, null);
