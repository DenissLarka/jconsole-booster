...
public class Formatter {
    ...
    public static DateFormat getDateTimeFormat(String dtfStr) {
        int dateStyle = -1;
        int timeStyle = -1;
    ...
    public static String newRow(String label, String value) {
        return newRow(label, value, 2);
    }

    public static String newRow(String label, String value, int columnPerRow) {
        if (label == null) {
            label = "";
        } else {
            label += ":&nbsp;";
    ...
    public static String newRow(String label1, String value1, String label2, String value2) {
