...
public class XOpenTypeViewer extends JPanel implements ActionListener {
    ...
    abstract static class XOpenTypeData extends JTable {
        ...
        public String getToolTip(int row, int col) {
            if (col == 1) {
                ...
                if (value != null) {
                    if (isClickableElement(value)) return Messages.DOUBLE_CLICK_TO_VISUALIZE + ". " + value.toString();
            ...
            while (it.hasNext()) {
                ...
                if (val == null) {
                    ...
                    if (openType instanceof CompositeType) {
                        ...
                        rowData[1] = new XTabularFlatTable(this, (TabularData) val);
                    }
                }
                // Update column width
                String str = null;
        ...
        private void load() {
            ...
            for (int i = 0; i < size; i++) {
                rowData[0] = isTabularType
                        ? new XTabularFlatTable(this, (TabularData) Array.get(val, i))
                        : Array.get(val, i);
    ...
    public static Component loadOpenType(Object value) {
        if (value instanceof TabularData td) {
            return new TabularDataPanel(td);
        }
        Component comp = null;
    ...
    private XOpenTypeViewer(Object value) {
        ...
        if (value instanceof CompositeData) {
            ...
            comp = new XTabularFlatTable(null, (TabularData) value);
    ...
    void setOpenType(XOpenTypeData data) {
        ...
        if (!(data instanceof XViewedTabularData)) {
            ...
            if (hasMoreThanOneElement) {
                tabularLabel.setText(Resources.format(
                        Messages.MBEANS_TAB_TABULAR_NAVIGATION_MULTIPLE,
        ...
        if (!(data instanceof XViewedArrayData)) {
            ...
            if (hasMoreThanOneElement) {
                compositeLabel.setText(Resources.format(
                        Messages.MBEANS_TAB_COMPOSITE_NAVIGATION_MULTIPLE,
    ...
    private void setupDisplay(XOpenTypeData data) {
        ...
        container = new JScrollPane(
                data, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
