...
public class BorderedComponent extends JPanel implements ActionListener {
     ...
     * with the addition of a JComponent (JLabel, JPanel, etc) in the default
     * position.
     * <p>
     * If the border property value is not specified in the constructor or by
     * invoking the appropriate set method, the property value will be defined by
     * the current look and feel, using the following property name in the Defaults
     * Table:
     * <ul>
    ...
    protected static class LabeledBorder extends TitledBorder {
        ...
        /**
         * Creates a LabeledBorder instance with the specified border and an empty
         * label.
         *
         * @param border
         *            the border
        ...
        public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
            ...
            Rectangle grooveRect = new Rectangle(
