...
public class AboutDialog extends InternalDialog {
    ...
    public AboutDialog(JConsole jConsole) {
        ...
        ImageIcon brandLogoIcon = new ImageIcon(getClass().getResource("/com/druvu/jconsole/resources/brandlogo.png"));
    ...
    private static class HighlightPainter extends DefaultHighlighter.DefaultHighlightPainter {
        ...
        public Shape paintLayer(Graphics g, int offs0, int offs1, Shape bounds, JTextComponent c, View view) {
            ...
            g2d.fill(dashedStroke.createStrokedShape(
                    new Rectangle2D.Float(alloc.x, alloc.y, alloc.width - 1, alloc.height - 1)));
            return alloc;
        }
    }
}
