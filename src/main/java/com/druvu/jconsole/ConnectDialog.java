...
public class ConnectDialog extends InternalDialog
    ...
    public ConnectDialog(JConsole jConsole) {
        ...
        Utilities.setAccessibleName(statusBar,
        ...
        Utilities.setAccessibleName(remoteTF,
        ...
        Utilities.setAccessibleName(userNameTF,
        ...
        Utilities.setAccessibleName(passwordTF,
    ...
    public void revalidate() {
        ...
        hintTextColor =
            Utilities.ensureContrast(disabledForeground,
                           UIManager.getColor("Panel.background"));
        disabledTableCellColor =
            Utilities.ensureContrast(new Color(0x808080),
